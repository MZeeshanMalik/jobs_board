...
const socialLinks = [
  ...
  {
    href: "https://github.com/MZeeshanMalik",
    label: "GitHub",
    icon: (
      <svg
        className="w-5 h-5"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            <Link
              href="/"
              className="inline-flex items-center gap-2 font-bold text-gray-900 hover:text-rose-600 transition-colors"
            ...
            <p className="mt-4 text-sm text-gray-600 max-w-xs leading-relaxed">
              Find your next opportunity or hire top talent. Curated roles from
              leading companies.
            </p>
            ...
            <div className="mt-6 flex items-center gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="inline-flex items-center justify-center w-9 h-9 rounded-lg text-gray-400 hover:text-rose-600 hover:bg-rose-50 transition-colors"
                >
                  {s.icon}
                </a>
              ))}
